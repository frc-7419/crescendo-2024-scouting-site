...
const SetScouterSchedule = ({matches, loading}: { matches: Match[], loading: any, time: Date }) => {
    ...
    const [blueOneId, setBlueOne] = useState<Key | null>('');
    const [blueTwoId, setBlueTwo] = useState<Key | null>('');
    const [blueThreeId, setBlueThree] = useState<Key | null>('');
    const [redOneId, setRedOne] = useState<Key | null>('');
    const [redTwoId, setRedTwo] = useState<Key | null>('');
    const [redThreeId, setRedThree] = useState<Key | null>('');
